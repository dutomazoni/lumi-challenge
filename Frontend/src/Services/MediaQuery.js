...
const xLSmallMedia = window.matchMedia('(min-width: 600px) and (max-width: 736.99px)');
const smallMedia = window.matchMedia('(min-width: 737px) and (max-width: 959.99px)');
...
[xSmallMedia, xLSmallMedia, smallMedia, mediumMedia, largeMedia].forEach(media => {
  media.addListener((e) => {
...
function getScreenSize() {
  return {
    ...
    isXLSmall: xLSmallMedia.matches,
